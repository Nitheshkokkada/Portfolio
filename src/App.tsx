              ...
              <div className="bg-white dark:bg-slate-800 p-10 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-700">
                <form className="space-y-6" onSubmit={handleSubmit}>
                  <div className="space-y-2">
                    ...
                    {/* Security: Enforce input length limit to prevent client-side resource exhaustion */}
                  ...
                  <div className="space-y-2">
                    ...
                    {/* Security: Limit email length to RFC 5321 standard max length (254 chars) */}
                  ...
                  <div className="space-y-2">
                    ...
                    {/* Security: Limit message length to mitigate DoS payload submission */}
