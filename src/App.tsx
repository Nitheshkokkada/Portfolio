              ...
              <div className="bg-white dark:bg-slate-800 p-10 rounded-3xl shadow-xl border border-slate-100 dark:border-slate-700">
                <form className="space-y-6" onSubmit={handleSubmit}>
                  <div className="space-y-2">
                    ...
                    {/* Added maxLength to restrict input size and prevent client-side DoS/overflow vulnerabilities */}
                  ...
                  <div className="space-y-2">
                    ...
                    {/* Added maxLength to restrict input size and prevent client-side DoS/overflow vulnerabilities */}
                    <input required type="email" maxLength={100} className="w-full p-4 bg-slate-50 dark:bg-slate-700 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500/20 dark:text-white transition-all" placeholder="hello@example.com" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-bold text-slate-400 dark:text-slate-500 uppercase tracking-widest ml-1">Message</label>
                    {/* Added maxLength to restrict input size and prevent client-side DoS/overflow vulnerabilities */}
                    <textarea required rows={4} maxLength={1000} className="w-full p-4 bg-slate-50 dark:bg-slate-700 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500/20 dark:text-white transition-all" placeholder="Tell me about your project..." />
                  </div>
                  <button 
